...
The accuracy and trustworthiness of the AV is well documented by Edward F. Hills, in his book titled [The King James Version Defended](https://archive.org/details/TheKingJamesVersionDefended/mode/2up). Originally published in 1956, Hills provides solid evidence that the AV should be preferred by English speaking people everywhere. With the utility available of the AVX Framework, developers can trust the accuracy of the sacred text. Therefore, they can focus on specific ues-cases and personas. The license is as free as the gospel. Use it as you see fit, hopefully to the glory of God. The forthcomning 2024 release of AV-Bible will be built upon this sound foundation.
