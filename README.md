...
AV-Text Ministries has adopted the objective of the 47 original AV translators. Inspired by those before me, I want ***to make God's holy Truth to be yet more and more known!*** Four centuries later, it resonates as if it had been spoken only yesterday. While this is a lofty goal, I wholeheartedly embrace it! With all of the features of Digital-AV exposed via Quelle, it enables any user to stay primitive, or search with deep nuances of language. It finds bible verses, whether queries be simple or complex. Leveraging this framework, developers are empowered with an intuitive command language. Digital-AV manifests the most trustworthy English text that God has yet availed to mankind [The Authorized Version of 1611, with standardized spelling revisions of the 1769 edition].

The accuracy and trustworthiness of the AV is well documented by Edward F. Hills, in his book titled [The King James Version Defended](https://archive.org/details/TheKingJamesVersionDefended/page/n23/mode/2up). Originally published in 1956, Hills provides solid evidence that the AV should be preferred by English speaking people everywhere. With the utility available of the AVX Framework, developers can trust the accuracy of the sacred text. Therefore, they can focus on specific ues-cases and personas. The license is as free as the gospel. Use it as you see fit, hopefully to the glory of God. The forthcomning 2024 release of AV-Bible will be built upon this sound foundation.
