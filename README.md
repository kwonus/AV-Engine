...
The accuracy and trustworthiness of the AV is well documented by Edward F. Hills, in his book titled [The King James Version Defended](https://archive.org/details/TheKingJamesVersionDefended/mode/2up). Originally published in 1956, Hills provides solid evidence that the AV should be preferred by English speaking people everywhere. Application developers can trust the utility of AVX Framework, and place their focus on specific ues-cases and personas. With a license as free as the gospel, use it as you see fit, hopefully to the glory of God. The forthcomning 2024 release of AV-Bible will be built upon this sound foundation.
